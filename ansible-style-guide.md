...
#### d6. Роли. Необязательные аргументы (подкаталог `defaults/`)

#### d7. Роли. Приватные переменные (подкаталог `vars/`)
...
#### d8. Роли. Область видимости переменных
