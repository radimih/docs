...
Обрамлять в кавычки (одинарные или двойные) только когда:
...
* значение скаляра вступает в конфликт с синтаксисом YAML:
  ...
  * _содержит_ в себе комбинации `:<пробел>` и `<пробел>#`
  * _содержит_ в случае Flow Style Collection
    * символы
    * комбинации 
...
* значение скаляра содержит [escape-последовательность]().

Более подробно см. [Quoting](https://www.yaml.info/learn/quote.html).
