...
реальная необходимость (см. [Приложение 1. Когда в YAML требуется обрамлять скаляр в кавычки](#приложение-1-когда-в-yaml-требуется-обрамлять-скаляр-в-кавычки)).
...
#### Приложение 1. Когда в YAML требуется обрамлять скаляр в кавычки
