...
Если часть плейбука не должна выполняться на определённом стенде, то это достигается путём объявления
в inventory стенда соответствующих групп _пустыми_.

Например, устанавливать RabbitMQ на всех стендах, кроме **dev**:
