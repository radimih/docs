...
В случае возникновения необходимости взять скаляр в кавычки (см. приложение [Когда скаляр в YAML необходимо обрамлять в кавычки](#приложение-1-когда-скаляр-в-yaml-необходимо-обрамлять-в-кавычки)) **двойные** кавычки `"` используются вместо одинарных `'` только в двух случаях:
