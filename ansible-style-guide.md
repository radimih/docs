...
Пример того, как ведёт себя роль при разных значениях этого параметра см. в приложении [Как параметр private_role_vars влияет на работу с ролями](#приложение-2-как-параметр-privaterolevars-влияет-на-работу-с-ролями).
